...
def parse():
    ...
    parser.add_argument('-t','--text_prompts', help='Text Prompts', type=str2json, default=gp('text_prompts',{
    ...
    parser.add_argument('--diffusion_model', help='Diffusion Model', default=gp('diffusion_model','512x512_diffusion_uncond_finetune_008100'), choices=['512x512_diffusion_uncond_finetune_008100','256x256_diffusion_uncond'])
